...
#define DEVICE_ID "BLX-SENSOR-001"
#define DEVICE_NAME "BeamLink-Sensor"
#define DEVICE_TYPE "Sensor-Monitor"
#define FIRMWARE_VERSION "1.0.0"

// BLE Configuration
#define BLE_ENABLED true
#define BLE_NAME "BeamLink-Sensor"
#define BLE_POWER_DBM 9
#define BLE_ADV_INTERVAL_MS 100
#define BLE_SERVICE_UUID "12345678-1234-1234-1234-1234567890abc"
